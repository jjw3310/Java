<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" errorPage="addrbook_error.jsp" import="jspbook.addrbook.*"%>
<!DOCTYPE html>
<html>
<head>
...
<table border="1">
	<tr>
		<th>이 름</th>
		<td><input type="text" name="ob_name" value="<%=ab.getAb_name() %>"></td>
	</tr>
	<tr>
		<th>email</th>
		...
		<tr>
		<th>생 일</th>
		<td><input type="data" name="ab_birth" value="<%=ab.getAb_birth() %>"></td>
	</tr>
	<tr>
		<th>회 사</th>
