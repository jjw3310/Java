...
public class AddrBean { 
	...
	public boolean updateDB(AddrBook addrbook) {
		...
		String sql ="update addrbook set ab_name=?, ab_email=?, ab_birth=?, ab_tel=?, ab_addrs=?, ab_comdept=?, ab_memo=? where ab_id=?";		
	...
	public boolean insertDB(AddrBook addrbook) {
		...
		String sql ="insert into addrbook(ab_id,ab_name,ab_email,ab_birth,ab_tel,ab_addrs,ab_comdept,ab_memo) values(ab_seq.nextval,?,?,?,?,?,?,?)";
	...
	public AddrBook getDB(int gb_id) {
		...
		try {
			...
			addrbook.setAb_addrs(rs.getString("ab_addrs"));
