...
<form method="post" action="insertPro1.jsp">
	<table>
		<tr>
		...
		<tr>
			...
			<td class="content"><input id="tel" name="tel" type="text" size="20"
				maxlength="20" placeholder="02-1111-1111" required>
		<tr>
			<td class="label"><label for="hp">핸드폰번호</label>
			<td class="content"><input id="hp" name="hp" type="text" size="20"
				maxlength="20" placeholder="010-1313-1313" required>
		<tr>
