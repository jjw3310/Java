...
<div>
	<form id="updateform" method="post" action="/mvc/news.do">
		...
		작성자<input type="text" size="40" name="writer"  value="<%= vo.getWriter() %>"><br>
		제목<input type="text" size="40"  name="title" value="<%= vo.getTitle() %>"><br>		
		카테고리<input type="text" size="40"  name="key" value="<%= vo.getKategorie() %>"><br>
		
		내용<textarea  cols="42"  rows="7" name="content"><%= vo.getContent() %></textarea><br>		
	</form>	
...
<div class="insert">
	<form method="post" action="/mvc/news.do">
		...
		작성자<br><input type="text" placeholder="작성자명을 입력해주세요" size="40" name="writer"><br>
		제목<br><input type="text" placeholder="제목을 입력해주세요" size="40"  name="title"><br> 
		카테고리<br><input type="text" placeholder="카테고리를 입력해주세요 e.g)경제, 연예, 시사, 스포츠" size="40"  name="kategorie"><br> 
		내용<br><textarea  placeholder="내용을 입력해주세요"  cols="41"  rows="7" name="content"></textarea>
		<br>
