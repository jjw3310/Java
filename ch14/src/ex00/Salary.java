...
public class Salary extends JFrame {
	...
	public Salary() {
		...
		cboName.setModel(new DefaultComboBoxModel(new String[] {"김철수",
				"이순신", "이철호", "홍선호", "박수철"}));
		...
		cboJob.setModel(new DefaultComboBoxModel(new String[] {"선택하세요",
				"사원", "주임", "대리", "과장", "부장"}));
		...
		cboTaxRate.setModel(new DefaultComboBoxModel(new String[] {"면세(0%)",
				"3%", "5%"}));
